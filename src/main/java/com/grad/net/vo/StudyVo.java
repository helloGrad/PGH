...
public class StudyVo {
	...
	public String toString() {
		return "StudyVo [orgnzNo=" + orgnzNo + ", pCdNm=" + pCdNm + ", university=" + university + ", graduate="
				...
				+ slctnNotiDstnct + ", notiRegstDt=" + notiRegstDt + ", slctnBeginDt=" + slctnBeginDt + ", slctnEndDt="
				+ slctnEndDt + ", dday=" + dday + ", percent=" + percent + ", slctnTitle=" + slctnTitle + ", slctnYycl="
				+ slctnYycl + ", slctnSemstr=" + slctnSemstr + ", pchrgYn=" + pchrgYn + ", storgPath=" + storgPath
