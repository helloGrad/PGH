						...
						<ul class="w3-ul">
							<c:forEach items="${counselingList }" var="counselingVo"
								...
								<c:choose>									
									...
									<h5>답변</h5>
										<li class="w3-padding-16"><a href="/net/counseling/detail?no=${counselingVo.prntsWrtbtNo }&type=reply"><span class="w3-large reply-text">${counselingVo.wrtbtText }
										</span></a></li>	
									</c:when>
									<c:when test="${counselingVo.wrtbtTypeDstnct=='원글' }">
									<h5>질문</h5>
										<li class="w3-padding-16"><a href="/net/counseling/detail?no=${counselingVo.wrtbtNo }&type=prnts"><span class="w3-large">${counselingVo.wrtbtTitle }
										</span></a></li>	
									</c:when>
								</c:choose>
