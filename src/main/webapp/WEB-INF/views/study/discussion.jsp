        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-8">
                <div class="w3-container">
                    <div class="btn btn-danger web-volunteer">글 작성하기</div>
                ...
                <div class="w3-card-4 w3-margin">
                    ...
                    <div class="w3-container">
                        <h4><b>What are things about 5-star hotels that they do not want you to know?</b></h4>
                    ...
                    <div class="w3-container">
                        <h6>닉네임
                            <span class="w3-opacity">• August 15, 2017에 답변</span></h6>
                        <p>여기다 질문하지말고 알아서 찾아라 </p>
                    </div>

                    <div class="w3-container">
                        <div class="w3-button w3-padding-small w3-white w3-border w3-border-white w3-round-large">
                            answers<span class="w3-badge w3-white">12</span>
                        </div>
                        <div class="w3-button w3-padding-small w3-white w3-border w3-border-white w3-round-large">
                            Up <span class="w3-badge w3-white">10</span>
                        </div>
                        <div class="w3-button w3-padding-small w3-white w3-border w3-border-white w3-round-large">
                            Down <span class="badge"></span>
                        </div>
                ...
                <div class="w3-card-4 w3-margin">
                    ...
                    <div class="w3-container">
                        <h4><b>이런 귀한 곳에 누추한 분들이 오셨네.</b></h4>
                    </div>
