...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 centering">
				...
				<button class="tablinks" onclick="openTab(event, 'grad','admin')">대학원</button>
	...
	<div id="notigrad" class="col-lg-12">
			...
			<form class="login-form" id="login-form" name="loginform"
				method="post"
				action="${pageContext.servletContext.contextPath }/admin/noti">
			...
			<form class="login-form" id="login-form" name="loginform"
				...
				<div class=col-lg-8>
					...
					<div class="form-group">
						...
						<!--////////////////////// 주요 연구 분야 //////////////////////-->
						<textarea class="form-control" rows="4" id="" name="prmryResrchField"
							placeholder=" 예) 1. MZnSnO 기반 박막트랜지스터 제작, 전기적 및 광학적 특성 분석, 소자 특성 연구
										2. SrVO3 및 CaVO3 등의 신개념 전이금속 산화물 투명 전극 제작 및 응용연구
										3. 플라즈마-표면 상호작용 및 플라즈마 반도체 공정에의 응용 연구"></textarea>
					</div>
					...
					<div class="form-group">
						<label for="">▣ 전형방법</label>
						<!--////////////////////// 주요 연구 분야 //////////////////////-->
						<textarea class="form-control" rows="4" id="slsnMth" name="slsnMth"></textarea>
					</div>
					</p>
					<p class="contents">
					<div class="form-group">
						<label for="">▣ 제출서류</label>
						<!--////////////////////// 주요 연구 분야 //////////////////////-->
						<textarea class="form-control" rows="4" id="sbmtDocText" name="sbmtDocText"></textarea>
					</div>
					</p>
					<div class="form-group">
						<div class="form-group">
					...
					<div class="form-group">
						...
						<!--////////////////////// 담당자명 //////////////////////-->
						<input class="form-control input-lg" id="chrgrNm" name="chrgrNm" type="text">
					</div>
					<div class="form-group">
						<label for="inputlg"> ▣ 전화번호 </label>
						<!--////////////////////// 담당자 전화번호 //////////////////////-->
						<input class="form-control input-lg" id="chrgrTelNo" name="chrgrTelNo"
							type="text">
					</div>
					<div class="form-group">
				...
				<div class="col-lg-4">
					<div class="well">
						...
						<div class="checkbox">
							<label class="btn-lg btn-default btn-block"> <input
								name="incetSuprtYn" type="checkbox" value="Y">인센티브 지원 여부
							</label>
						</div>
						<div class="checkbox">
							<label class="btn-lg btn-default btn-block"> <input
						...
						<div class="checkbox">
							<label class="btn-lg btn-default btn-block"> <input
								name="resrchTaskJoingYn" type="checkbox" value="Y">연구 과제
								참가 여부
							</label>
						</div>
						<div class="checkbox">
						...
						<div class="form-group">
							...
							<input class="form-control input-lg" id="suprtFvrText" name="suprtFvrText" type="text">
						</div>
		                ...
		                <div class="checkbox">
		                    <label class="btn-lg btn-default btn-block" >
		                        <input type="checkbox" name="onlineSuprtYn" value="Y">온라인 지원 신청 </label>
		                </div>
