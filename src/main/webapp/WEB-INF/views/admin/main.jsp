...
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-form">
					<form method="post" action="${pageContext.servletContext.contextPath }/admin/upload" enctype="multipart/form-data">
						<label class="block-label" for="title">사이트 타이틀</label>
						<input id="title" name="title" type="text" value="관리자페이지입니다. ">
						
						<label class="block-label" for="welcomeMessage">환영 메세지</label>
						<input id="welcomeMessage" name="welcomeMessage" type="text" value="안녕하세요">
